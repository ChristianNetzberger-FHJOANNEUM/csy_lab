...
PACKAGE busdef IS
  ...
  type s128bus_o_t is record
    rdata: std_logic_vector(127 downto 0);
    ack: std_logic;
  end record;

  type s128bus_i_t is record
    addr: std_logic_vector(31 downto 0);
   ...
   constant s128bus_null_c: s128bus_o_t := ((others => '0'),'0');
   ...
   constant s128bus_o_null_c: s128bus_o_t := ((others => '0'),'0');
   constant s128bus_i_null_c: s128bus_i_t := ((others => '0'),(others => '0'),(others => '0'),'0','0');
