-- VHDL Entity axi_mst_sbus_bridge.tb_top.symbol
--
-- Created:
...
--
-- VHDL Architecture axi_mst_sbus_bridge.tb_top.struct
--
-- Created:
--          by - net.UNKNOWN (KPERSM7467)
--          at - 12:00:00 11.05.2018
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2016.2 (Build 5)
--
LIBRARY ieee;
...
-- Ports of Axi Slave Bus Interface S00_AXI
   ...
   for all : axi_slave64 use entity axi_mst_sbus_bridge.axi_slave64;
   for all : cnt_modulus use entity axi_mst_sbus_bridge.cnt_modulus;
   for all : sbus_termination use entity axi_mst_sbus_bridge.sbus_termination;
   for all : test_axi_mst use entity axi_mst_sbus_bridge.test_axi_mst;
   for all : to_sbus use entity axi_mst_sbus_bridge.to_sbus;
   for all : top_signal_connector_v1_0 use entity axi_mst_sbus_bridge.top_signal_connector_v1_0;
   -- pragma synthesis_on
