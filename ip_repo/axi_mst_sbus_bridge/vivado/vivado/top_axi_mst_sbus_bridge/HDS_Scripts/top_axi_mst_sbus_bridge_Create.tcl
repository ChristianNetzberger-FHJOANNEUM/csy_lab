...
set xilinxProject "./top_axi_mst_sbus_bridge.xpr"
set library axi_mst_sbus_bridge
set unit top_axi_mst_sbus_bridge
set view struct
set removeIP 0
set removeHDL 0
set forceRecreate 0
...
puts "   ./HDS_Scripts/top_axi_mst_sbus_bridge_fileList.tcl"
set hdlFileList ./HDS_Scripts/top_axi_mst_sbus_bridge_fileList.tcl
