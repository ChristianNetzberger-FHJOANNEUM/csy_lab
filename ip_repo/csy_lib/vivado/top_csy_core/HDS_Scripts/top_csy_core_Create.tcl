...
set xilinxProject "./top_csy_core.xpr"
set library csy_lib
set unit top_csy_core
set view struct
set removeIP 0
set removeHDL 0
set forceRecreate 0
...
puts "   ./HDS_Scripts/top_csy_core_fileList.tcl"
set hdlFileList ./HDS_Scripts/top_csy_core_fileList.tcl
